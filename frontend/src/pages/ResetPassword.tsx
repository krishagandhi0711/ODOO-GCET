                    ...
                    <div className="glass-strong rounded-3xl p-8 relative overflow-hidden border border-white/5 border-t-white/10 shadow-2xl shadow-black/20">
                        ...
                        {!tokenValid ? (
                            ...
                            <div className="text-center space-y-6 py-4 animate-fade-in">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold text-foreground mb-2">Invalid Session</h2>
                                    <p className="text-sm text-muted-foreground">
                                        This password reset link is invalid or has expired for security reasons.
                                    </p>
                                </div>

                                <div className="pt-4 space-y-4">
                                    <Link to="/forgot-password" stroke-none>
                                        <Button className="w-full h-11 bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-xl shadow-lg shadow-primary/20">
                                            Request New Link
                                        </Button>
                                    </Link>
                                    <Link
                            ...
                            <>
                                <div className="flex items-center justify-center gap-2 mb-8 py-2 px-4 rounded-full bg-primary/5 border border-primary/10 w-fit mx-auto">
                                    ...
                                    <span className="text-[10px] uppercase font-bold tracking-widest text-primary/80">Secure Override</span>
                                </div>

                                <div className="mb-8 text-center">
                                    <h2 className="text-2xl font-bold text-foreground">Set New Password</h2>
                                    <p className="text-sm text-muted-foreground mt-2">
                                        Establish a new secure credential for your professional account.
                                    </p>
                                </div>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="p-4 rounded-2xl bg-primary/5 border border-primary/10">
                                        <p className="text-xs text-muted-foreground leading-relaxed">
                                            ...
                                            Minimum 8 characters. We recommend a mix of special characters and numbers.
                                        </p>
                                    </div>
